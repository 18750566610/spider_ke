...
def transFrom():
    link = ALLPage.getLink(11936535, "fanbox", "Thanabis")
...
def getWorkLink():
    ...
    for i in range(len(link)):
        ...
        for j in bs.findAll("a"):
            ...
            count1 = i
            if count1 == 0:
                txt111 = open(f"{path}{count}_content.txt", "w", encoding="utf-8")
                txt111.truncate(0)
            txt = open(f"{path}{count}_content.txt", "a+", encoding="utf-8")
...
if __name__ == "__main__":
    ...
    # downloadWorkLink()
    # downloadImgLink()
    # link = ['https://kemono.party/fanbox/user/10125263/post/4727103',
    #         'https://kemono.party/fanbox/user/10125263/post/4228833',
    #         'https://kemono.party/fanbox/user/10125263/post/4197832',
    #         'https://kemono.party/fanbox/user/10125263/post/4164963',
    #         'https://kemono.party/fanbox/user/10125263/post/4132957',
    #         'https://kemono.party/fanbox/user/10125263/post/4104733']
    getWorkLink()
